...
public final class ConfigBootstrap {
    ...
    public void ensureEditableExternalFolder() {
        try {
            ...
            copyFromJarNoOverwriteWithFallback("Common/Sounds/", externalPluginFolder.resolve("Common/Sounds"));
            copyFromJarNoOverwriteWithFallback("Server/Audio/SoundEvents/", externalPluginFolder.resolve("Server/Audio/SoundEvents"));
        } catch (Exception e) {
            logger.at(Level.WARNING).log(
                    "[EcoCoins] No pude exportar configs (Coins/Languages/Common/Sounds + Server/Audio/SoundEvents). Continúo igual. Causa: %s",
                    e.toString()
            );
        }
    }
 ...
 // Exporta solo las carpetas necesarias, no Items/ y Common/
    public void ensureEditableExportedAssetPack() {
        try {
            ...
            copyFromJarNoOverwriteWithFallback("Common/Sounds/", externalAssetPackFolder.resolve("Common/Sounds"));
            copyFromJarNoOverwriteWithFallback("Server/Audio/SoundEvents/", externalAssetPackFolder.resolve("Server/Audio/SoundEvents"));

        } catch (Exception e) {
            logger.at(Level.WARNING).log(
                    "[EcoCoins] No pude exportar assetpack (EcoCoins/Coins/Languages/Common/Sounds + Server/Audio/SoundEvents). Continúo igual. Causa: %s",
                    e.toString()
            );
        }
    }    
