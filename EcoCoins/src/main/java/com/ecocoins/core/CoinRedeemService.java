...
public final class CoinRedeemService {
    ...
    public CoinRedeemService(HytaleLogger logger, CoinManager coinManager, TheEconomyService economy, LanguageManager languageManager, BalanceHudService hudService, SuccessMessageBurstService successBurstService, boolean debugLogs) {
        this.logger = logger;
    ...
    private boolean redeemByItemId(Player player, String itemId, String source) {
        ...
        successBurstService.sendSuccess(player, "redeem.success", 1, coin.pay);
