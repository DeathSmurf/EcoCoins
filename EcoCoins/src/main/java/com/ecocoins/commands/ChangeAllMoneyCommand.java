...
public final class ChangeAllMoneyCommand extends AbstractPlayerCommand {
    ...
    public ChangeAllMoneyCommand(LanguageManager lang, CoinManager coins, TheEconomyService economy, BalanceHudService hudService, CommandTimeoutService timeoutService, SuccessMessageBurstService successBurstService) {
    ...
    private void executeNow(Store<EntityStore> store,
        ...
        successBurstService.sendSuccess(player, "command.changeall.success", totalCoins, totalPay);
