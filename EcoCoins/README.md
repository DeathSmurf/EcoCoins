...
## Cómo verificar rápido en consola del server

Al iniciar el plugin debes ver en logs `interactionTrigger=Secondary`.
Si ves `Use`, estás ejecutando un jar viejo.
